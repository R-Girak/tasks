...
namespace task3.Tests.Positive
{
    ...
    /// Test case.
    /// </summary>
    public class NetCard2Ports_10_50_Test : NetCardFlowBuilder
    {
        ...
        /// Test case #8.
        /// </summary>
        public const string testName = "NetCard2Ports_10_50_Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetCard2Ports_10_50_Test" /> class.
        /// </summary>
        /// <param name="testName"></param>
        /// <param name="testDescription"></param>
        public NetCard2Ports_10_50_Test(string testName, string testDescription) : base(testName, testDescription)
        {
        }
