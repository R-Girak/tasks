...
namespace task3.Tests.Positive
{
    ...
    /// Test case.
    /// </summary>
    public class NetCard1Port_25_Test : NetCardFlowBuilder
    {
        ...
        /// Test case #3.
        /// </summary>
        public const string testName = "NetCard1Port_25_Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetCard1Port_25_Test" /> class.
        /// </summary>
        /// <param name="testName"></param>
        /// <param name="testDescription"></param>
        public NetCard1Port_25_Test(string testName, string testDescription) : base(testName, testDescription)
        {
        }
