...
namespace task3.Tests.Positive
{
    ...
    /// Test case.
    /// </summary>
    public class NetCard1Port_100_Test : NetCardFlowBuilder
    {
        ...
        /// Test case #5.
        /// </summary>
        public const string testName = "NetCard1Port_100_Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetCard1Port_100_Test" /> class.
        /// </summary>
        /// <param name="testName"></param>
        /// <param name="testDescription"></param>
        public NetCard1Port_100_Test(string testName, string testDescription) : base(testName, testDescription)
        {
        }
