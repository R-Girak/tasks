...
namespace task3.Tests.Positive
{
    ...
    /// Test case.
    /// </summary>
    public class NetCard1Port_50_Test : NetCardFlowBuilder
    {
        ...
        /// Test case #4.
        /// </summary>
        public const string testName = "NetCard1Port_50_Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetCard1Port_50_Test" /> class.
        /// </summary>
        /// <param name="testName"></param>
        /// <param name="testDescription"></param>
        public NetCard1Port_50_Test(string testName, string testDescription) : base(testName, testDescription)
        {
        }
