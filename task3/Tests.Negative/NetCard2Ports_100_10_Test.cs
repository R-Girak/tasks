...
namespace task3.Tests.Positive
{
    ...
    /// Test case.
    /// </summary>
    public class NetCard2Ports_100_10_Test : NetCardNegativeFlowBuilder
    {
        ...
        /// Test case #11.
        /// </summary>
        public const string testName = "NetCard2Ports_100_10_Test";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NetCard2Ports_100_10_Test" /> class.
        /// </summary>
        /// <param name="testName"></param>
        /// <param name="testDescription"></param>
        public NetCard2Ports_100_10_Test(string testName, string testDescription) : base(testName, testDescription)
        {
        }
